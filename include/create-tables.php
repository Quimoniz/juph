...
$create_sql .= '`frequency` INT NOT NULL DEFAULT 0,';
$create_sql .= '`trackid` INT NOT NULL DEFAULT 0,';
$create_sql .= '`stereo` ENUM(\'MONO\',\'STEREO\',\'UNKNOWN\') DEFAULT \'UNKNOWN\',';
$create_sql .= '`trackname` VARCHAR(1024) CHARACTER SET utf8 NULL,';
$create_sql .= '`comment` VARCHAR(1024) CHARACTER SET utf8 NULL,';
...
$create_sql .= '`tagtype` ENUM(\'UNKNOWN\', \'ALBUM\', \'ARTIST\', \'GENRE\', \'YEAR\', \'CODEC\', \'FORMAT\', \'DIRECTORY\') NOT NULL DEFAULT \'UNKNOWN\',';
$create_sql .= '`description` TEXT CHARACTER SET utf8 NULL,';
$create_sql .= 'UNIQUE KEY(`id`),';
$create_sql .= 'CONSTRAINT `tagnametype` UNIQUE KEY(`tagname`, `tagtype`),';
$create_sql .= 'INDEX(`tagname`)';
$create_sql .= ') ENGINE=InnoDB; ';
// TABLE `relation_tags`
